    ...
    <div class="w-full max-w-sm p-8 bg-white rounded-2xl shadow-lg">
      ...
      <form action="#" method="POST" class="space-y-5">
        <div>
          ...
          <input class="w-full mt-1 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-600"
        ...
        <div>
          <label for="confirm-password" class="text-sm font-medium text-emerald-900">Confirm Password</label>
          <input class="w-full mt-1 px-4 text-sm py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-600"
            type="password" id="password-confirm" name="password-confirm" placeholder="Confirm your password" minlength="6" required />
        </div>
        ...
        <button type="submit"
          class="w-full bg-emerald-800 text-white py-2 rounded-xl hover:bg-green-600 transition duration-300">
          Create
        </button>
      </form>
    </div>
